...
A = xlsread('results_OA_doble_0.5_export.xlsx','alphaCVaRvector','B1:B11');
alphaVector = A(:,end);
alphaVector(1) = 0;

A = xlsread('results_OA_doble_0.5_export.xlsx','ProfitScen','D1:D805200');
...
yticks([2500:500:4500]);
yl = ylim;
ylim([yl(1) 4500])

% Save the figure as .fig.
savefig(fig,'figure25.fig');
