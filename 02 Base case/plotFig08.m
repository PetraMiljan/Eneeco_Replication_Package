...
fig = figure;
plot(alphaVector,ProfitAlphaDA,'o-','LineWidth',2);
xlabel('Confidence level, \alpha','Interpreter','tex','FontSize',16,'FontName','Times New Roman');
ylabel('Profit (€)','Interpreter','tex','FontSize',16,'FontName','Times New Roman');
ymin = -500;
ymax = 3500;
hold on;
plot(alphaVector,ProfitAlphaH2cvar,'o-','LineWidth',2);
plot(alphaVector,ProfitAlphaIPDcvar,'o-','LineWidth',2);
set(gcf, 'Position', [100 100 800 400])
xticks(alphaVector);
axis([0 0.999 ymin ymax]);
legend('Day-ahead electricity trading profit','Hydrogen trading profit','Imbalance profit','FontSize',12,'Interpreter','tex','Location','northeast','FontName','Times New Roman');
grid on;
