...
% Analysis of the terms of the objective function for different values of
% the uncertainty budget
% Plot Figure 7
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Authors: Álvaro García Cerezo, Petra Miljan, Hrvoje Pandžić
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% I analyze the terms of the objective function for different values of 
% Gamma.
...
fig = figure;
plot(gammaVector,ProfitGammaDA,'o-','LineWidth',2);
xlabel('Uncertainty level (h)','Interpreter','none','FontSize',16,'FontName','Helvetica');
ylabel('Profit (€)','Interpreter','none','FontSize',16,'FontName','Helvetica');
ymin = -6000;
ymax = 13500;
hold on;
plot(gammaVector,ProfitGammaH2,'o-','LineWidth',2);
plot(gammaVector,ProfitGammaIPD,'o-','LineWidth',2);
set(gcf, 'Position', [100 100 800 400])
xticks(gammaVector);
yticks([-5000:2500:12500])
axis([0 24 ymin ymax]);
legend('Day-ahead electricity trading profit','Hydrogen trading profit','Imbalance profit','FontSize',12,'Interpreter','none','Location','northeast','FontName','Helvetica');
grid on;
