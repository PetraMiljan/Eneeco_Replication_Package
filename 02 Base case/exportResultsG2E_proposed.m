...
filename = 'resultsProposed_alpha.xlsx';

% alphaCVaRvector
A = readgdx('resultsProposed_alpha.gdx','alphaCVaRvector');
A(:,1)=A(:,1)-min(A(:,1))+1;
A(A==1e-6) = 0;
alphaCVaRvector = A;
writematrix(alphaCVaRvector,filename,'Sheet','alpha','Range','B2');
...
% mpDA
A = readgdx('resultsProposed_alpha.gdx','par_mpDA');
A(:,1)=A(:,1)-min(A(:,1))+1;
A(:,2)=A(:,2)-min(A(:,2))+1;
A(A==1e-6) = 0;
mpDA = A;
...
% rIB
A = readgdx('resultsProposed_alpha.gdx','par_rIB');
A(:,1)=A(:,1)-min(A(:,1))+1;
A(:,2)=A(:,2)-min(A(:,2))+1;
A(:,3)=A(:,3)-min(A(:,3))+1;
A(A==1e-6) = 0;
...
% dIB
A = readgdx('resultsProposed_alpha.gdx','par_dIB');
A(:,1)=A(:,1)-min(A(:,1))+1;
A(:,2)=A(:,2)-min(A(:,2))+1;
A(:,3)=A(:,3)-min(A(:,3))+1;
A(A==1e-6) = 0;
...
% resRDA
A = readgdx('resultsProposed_alpha.gdx','par_resRDA');
A(:,1)=A(:,1)-min(A(:,1))+1;
A(:,2)=A(:,2)-min(A(:,2))+1;
A(A==1e-6) = 0;
resRDA = A;
...
% resRIB
A = readgdx('resultsProposed_alpha.gdx','par_resRIB');
A(:,1)=A(:,1)-min(A(:,1))+1;
A(:,2)=A(:,2)-min(A(:,2))+1;
A(:,3)=A(:,3)-min(A(:,3))+1;
A(A==1e-6) = 0;
...
% chBDA
A = readgdx('resultsProposed_alpha.gdx','par_chBDA');
A(:,1)=A(:,1)-min(A(:,1))+1;
A(:,2)=A(:,2)-min(A(:,2))+1;
A(A==1e-6) = 0;
chBDA = A;
...
% chBIBminus
A = readgdx('resultsProposed_alpha.gdx','par_chBIBminus');
A(:,1)=A(:,1)-min(A(:,1))+1;
A(:,2)=A(:,2)-min(A(:,2))+1;
A(:,3)=A(:,3)-min(A(:,3))+1;
A(A==1e-6) = 0;
...
% chBIBplus
A = readgdx('resultsProposed_alpha.gdx','par_chBIBplus');
A(:,1)=A(:,1)-min(A(:,1))+1;
A(:,2)=A(:,2)-min(A(:,2))+1;
A(:,3)=A(:,3)-min(A(:,3))+1;
A(A==1e-6) = 0;
...
% disBDA
A = readgdx('resultsProposed_alpha.gdx','par_disBDA');
A(:,1)=A(:,1)-min(A(:,1))+1;
A(:,2)=A(:,2)-min(A(:,2))+1;
A(A==1e-6) = 0;
disBDA = A;
...
% disBIBminus
A = readgdx('resultsProposed_alpha.gdx','par_disBIBminus');
A(:,1)=A(:,1)-min(A(:,1))+1;
A(:,2)=A(:,2)-min(A(:,2))+1;
A(:,3)=A(:,3)-min(A(:,3))+1;
A(A==1e-6) = 0;
...
% disBIBplus
A = readgdx('resultsProposed_alpha.gdx','par_disBIBplus');
A(:,1)=A(:,1)-min(A(:,1))+1;
A(:,2)=A(:,2)-min(A(:,2))+1;
A(:,3)=A(:,3)-min(A(:,3))+1;
A(A==1e-6) = 0;
...
% soeBDA
A = readgdx('resultsProposed_alpha.gdx','par_soeBDA');
A(:,1)=A(:,1)-min(A(:,1))+1;
A(:,2)=A(:,2)-min(A(:,2))+1;
A(A==1e-6) = 0;
soeBDA = A;
...
% soeBIB
A = readgdx('resultsProposed_alpha.gdx','par_soeBIB');
A(:,1)=A(:,1)-min(A(:,1))+1;
A(:,2)=A(:,2)-min(A(:,2))+1;
A(:,3)=A(:,3)-min(A(:,3))+1;
A(A==1e-6) = 0;
...
% elEDA
A = readgdx('resultsProposed_alpha.gdx','par_elEDA');
A(:,1)=A(:,1)-min(A(:,1))+1;
A(:,2)=A(:,2)-min(A(:,2))+1;
A(A==1e-6) = 0;
elEDA = A;
...
% elEIB
A = readgdx('resultsProposed_alpha.gdx','par_elEIB');
A(:,1)=A(:,1)-min(A(:,1))+1;
A(:,2)=A(:,2)-min(A(:,2))+1;
A(:,3)=A(:,3)-min(A(:,3))+1;
A(A==1e-6) = 0;
...
% elEIBminus
A = readgdx('resultsProposed_alpha.gdx','par_elEIBminus');
A(:,1)=A(:,1)-min(A(:,1))+1;
A(:,2)=A(:,2)-min(A(:,2))+1;
A(:,3)=A(:,3)-min(A(:,3))+1;
A(A==1e-6) = 0;
...
% elEIBplus
A = readgdx('resultsProposed_alpha.gdx','par_elEIBplus');
A(:,1)=A(:,1)-min(A(:,1))+1;
A(:,2)=A(:,2)-min(A(:,2))+1;
A(:,3)=A(:,3)-min(A(:,3))+1;
A(A==1e-6) = 0;
